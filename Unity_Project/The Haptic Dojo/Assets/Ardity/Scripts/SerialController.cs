...
public class SerialController : MonoBehaviour
{
    ...
    public void SendSerialMessage(string message)
    {
        ...
        // double mymessage = sword.mySum;

    
        serialThread.SendMessage(message);
    }
    public void SendSerialMessageDouble(double myDouble)
    {
        // GameObject myobj = GameObject.Find("Katana_LODB");
        // SwordHaptics sword = myobj.GetComponent<SwordHaptics>();
        // myDouble = sword.mySum;
        // SwordHaptics sword;
        ...
        serialThread.SendMessage(myDouble);
    }
    // public void SendSerialMessage(SwordHaptics sword)
    // {
        
    //     double message = sword.mySum;
